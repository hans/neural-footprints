...
import numpy as np
from analyses.plot_figures import plot_dissociation, plot_dissociation_combined, plot_predicted_frames
...
plot_dissociation_combined(plot_data, fig_dir=fig_dir)
